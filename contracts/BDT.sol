...
contract BDT {
    ...
    // --- ERC20 Data ---
    string  public constant name     = "Block Duelers";
    string  public constant symbol   = "BDT";
    uint8   public constant decimals = 18;
    uint256 public constant totalSupply = 50000e18;
    ...
    function transferFrom(address src, address dst, uint value)
        public returns (bool)
    {
        require(balanceOf[src] >= value, "BDT/insufficient-balance");
        if (src != msg.sender && allowance[src][msg.sender] != uint(-1)) {
            require(allowance[src][msg.sender] >= value, "BDT/insufficient-allowance");
